class MyCounter extends HTMLElement {
    ...
    render() {
        ...
        <link rel="stylesheet" href="/src/components/frame/styles.css">
        <section class = "boton">

        <button id="Like"><image src="./imagenes/Like.png" width=20px></button>
...
customElements.define("my-contador", MyCounter);
